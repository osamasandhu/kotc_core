...
part of 'sub_categories_dto.dart';
...
abstract class $SubCategoryDTOCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String? mainCategoryId});
}
...
class _$SubCategoryDTOImpl implements _SubCategoryDTO {
  _$SubCategoryDTOImpl(
      {required this.id, required this.name, this.mainCategoryId});
  ...
  @override
  String toString() {
    return 'SubCategoryDTO(id: $id, name: $name, mainCategoryId: $mainCategoryId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, mainCategoryId);
...
abstract class _SubCategoryDTO implements SubCategoryDTO {
  factory _SubCategoryDTO(
      ...
      final String? mainCategoryId}) = _$SubCategoryDTOImpl;
